        ...
        <div id='projFlexContainerHS'>
            ...
            <div className='rows'>
                ...
                <div className='halfWidth pushImg'>
                    ...
                    <a className='projectLinks' href='https://impulsecreative.com/company'><h3 className='center'>Impulse Creative Front End Developer</h3><h5 className='center'>Web Developer for Impulse Creative</h5><h5 className='center' id='hubspotOrange'>HubSpot Websites, Themes & Templates. API Integrations, Custom Objects, HubDB, and other awesome CMS applications.</h5></a>
                </div>
