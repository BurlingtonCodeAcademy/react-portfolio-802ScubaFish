...
function Experience() {
    return ( <
        ...
        <
        a href = 'https://www.linkedin.com/in/christian-dow/'
        target = "_blank"
        rel = "noopener noreferrer" > < img className = 'resumeImage1'
        src = {
            ResumePage1
        }
        alt = "Resume Page 1" > < /img></a >
        <
        p className = 'pageText1' > (Page 1) < /p> <
        a href = 'https://www.linkedin.com/in/christian-dow/'
        target = "_blank"
        rel = "noopener noreferrer" > < img className = 'resumeImage2'
        src = {
            ResumePage2
        }
        alt = "Resume Page 2" > < /img></a >
        <
        p className = 'pageText2' > (Page 2) < /p>

        <
        h3 id = 'center' > Like what you see ? < /h3> <
        Link className = 'contactMeLink'
        id = 'center'
        to = '/contact-me' > Fill out this form! < /Link> <
        /div>
