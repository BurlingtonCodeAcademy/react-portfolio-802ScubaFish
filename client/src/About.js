    ...
    return (
        ...
        <div id='flexContainer'>
            ...
            <div id='profileContainer'>
                ...
                <div id='subContainer'>
                    <div id='leftColumn'>
                        <h4><span id='subContainerTitles'>Name : </span> Christian Dow</h4>
                        <h4><span id='subContainerTitles'>Age : </span> 27 Years</h4>
                        <h4><span id='subContainerTitles'>Email : </span> ChiristianRDow@Gmail.com</h4>
                    </div>
                    <div id='rightColumn'>
                        <h4><span id='subContainerTitles'>Phone : </span> (802) 735-3393</h4>
                        <h4><span id='subContainerTitles'>Address : </span> Milton, VT 05468</h4>
                        <h4><span id='subContainerTitles'>Hobby : </span> Photography, Auto-X,<br />Hiking, and Videogaming</h4>
                    </div>
                </div>
                <div id='bottomRow'>
                    <h4>Favorite Color : <span id='subContainerTitles'>Turquoise</span>.</h4>
                </div>
            </div>
        </div>
